...
export const DEMO_EVENTS: NocturnaEvent[] = [
  { id: 'd1', slug: 'concrete-ritual-' + plus(0), title: 'Concrete Ritual', date: plus(0), start_time: '22:00', end_time: '06:00', venue_name: 'Vault 1904', neighborhood: 'Downtown LA', genres: ['techno'], lineup: ['Vera Holt', 'MODUL8', 'Iker Sanz'], price: '$25', status: 'featured', featured: true, source: 'manual', description: 'Peak-time warehouse techno in a 1904 bank vault. Concrete, strobes, a Funktion-One rig and nothing else.' },
  { id: 'd2', slug: 'glasshouse-sessions-' + plus(0), title: 'Glasshouse Sessions', date: plus(0), start_time: '21:00', venue_name: 'The Greenhouse', neighborhood: 'Arts District', genres: ['house'], lineup: ['Ama Diallo', 'Soft Static'], price: '$18', status: 'approved', source: 'manual' },
  { id: 'd3', slug: 'static-bloom-' + plus(0), title: 'Static Bloom', date: plus(0), start_time: '23:00', venue_name: 'Basement Echo', neighborhood: 'Echo Park', genres: ['electro'], lineup: ['Nocturna residents', 'Kito Vance'], is_free: true, price: 'Free RSVP', status: 'approved', source: 'manual' },
  { id: 'd4', slug: 'sable-sundown-' + plus(1), title: 'Sable Sundown', date: plus(1), start_time: '18:00', venue_name: 'Sable Rooftop', neighborhood: 'Hollywood', genres: ['house'], lineup: ['Lena Marlow (open to close)'], price: '$20', status: 'approved', source: 'manual' },
  ...
  { id: 'd6', slug: 'low-orbit-' + plus(2), title: 'Low Orbit', date: plus(2), start_time: '22:00', venue_name: 'Signal Room', neighborhood: 'Silver Lake', genres: ['minimal'], lineup: ['Hishi Tanaka', 'Grain Theory'], price: '$15', status: 'approved', source: 'manual' },
  { id: 'd7', slug: 'afterlight-' + plus(3), title: 'Afterlight', date: plus(3), start_time: '04:00', venue_name: 'Room Zero', neighborhood: 'Downtown LA', genres: ['techno'], lineup: ['Rotating residents'], price: '$20', status: 'approved', source: 'manual' },
  { id: 'd8', slug: 'pier-static-day-series-' + plus(4), title: 'Pier Static — Day Series', date: plus(4), start_time: '14:00', venue_name: 'Ocean Deck', neighborhood: 'Venice', genres: ['house'], lineup: ['Coastal Frequencies crew'], is_free: true, price: 'Free', status: 'approved', source: 'manual' },
];
